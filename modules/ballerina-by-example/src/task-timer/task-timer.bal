...
function main (string[] args) {
    ...
    // Schedule a timer task which initially runs 500ms from now and
    //there onwards runs every 1000ms.
...
function cleanup() returns (error e) {
    ...
    //We randomly return an error to show how the error is propagated to
    //the onError function when an error occurs in the onTrigger function.
