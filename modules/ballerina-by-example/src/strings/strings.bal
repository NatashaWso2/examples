function main (string[] args) {
    ...
    //Compares two strings, ignoring the case. Returns True if the strings
    ...
    //The original string, starting index and ending index should be
    //specified.
    ...
    //Returns the first index of the first occurrence of the substring
    //within the specified string.
    int index = statement.indexOf("on");
    println("IndexOf: " + index);

    //Returns the first index of the last occurrence of the substring
    //within the specified string.
    ...
    //Replaces the first instance of the replacePattern with the
    //replaceWith string.
    string s5 = statement.replaceFirst("Lion", "Tiger");
    println("ReplaceFirst: " + s5);

    //This replaces the replacePattern string with the replacement
    //string.
    string s6 = statement.replace("Lion", "Tiger");
    println("Replace: " + s6);

    //Replaces each substring of the replacePattern that matches the given
    //regular expression with the replacement string.
    ...
    //Returns an unescaped string by omitting the escape characters of
    //the original string.
    string s9 = statement.unescape();
    println("Unescape: " + s9);

    //Splits the string with the given regular expression to produce a
    //string array.
