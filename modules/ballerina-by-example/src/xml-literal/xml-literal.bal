function main (string[] args) {
    ...
    //A complex XML defined using the literal syntax, having nested
    ...
    //Defined namespaces. These are visible to all the XML literals
    //defined from here onwards.
    ...
    //XML interpolated with expressions, using '{{}}' notation.
    //Expression can be a previously defined variable, arithmetic
    //expressions or even a function call. These expressions get
