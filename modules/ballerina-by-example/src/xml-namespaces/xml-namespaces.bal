...
function main (string[] args) {
    // Namespaces can be declared at package levels, as well as function
    // level. The identifier followed by 'as' keyword is the prefix bound
    // to this namespace name.
    xmlns "http://ballerina.com/bb" as ns1;

    // Namespace declaration without the prefix, will define a default
    // namespace.
