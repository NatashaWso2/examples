...
service<jms> jmsService {
    resource onMessage (message m) {
        ...
        // For delivery mode we can use the built in constant as follows to
        // infer whether the message is a persistent message or not.
        ...
        // ReplyTo header is set with the name of the queue. You can retrieve
        // this value when receiving a message using the getHeader function
        // as well.
        ...
        // We can explicitly set the message type. If we use functions like
        // setStringPayload, setJSONPayload and setXMLPayload content type will
        // be set. And when we send the message the content type will be used
        // as the message type value.
